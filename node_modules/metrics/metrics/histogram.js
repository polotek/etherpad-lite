...
Histogram.prototype.printObj = function() {
  ...
  return {
    ...
    , min: this.min               || 0
    , max: this.max               || 0
    , variance: this.variance()   || 0
    , mean: this.mean()           || 0
    , std_dev: this.stdDev()      || 0
    , count: this.count           || 0
    , median: percentiles[0.5]    || 0
    , p75: percentiles[0.75]      || 0
    , p95: percentiles[0.95]      || 0
    , p98: percentiles[0.98]      || 0
    , p99: percentiles[0.99]      || 0
    , p999: percentiles[0.999]    || 0
    , unit: 'milliseconds'};
}
